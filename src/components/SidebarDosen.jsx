...
export function SidebarDosen() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            isOpen:
                isBukuOpen ||
                location.pathname.startsWith('/dosen/katalog-buku') ||
                location.pathname.startsWith('/dosen/histori-peminjaman-buku'),
            toggle: handleBukuToggle,
            subItems: [
                {
                    to: '/dosen/katalog-buku',
                    icon: (
                ...
                {
                    to: '/dosen/histori-peminjaman-buku',
                    icon: (
                        <ClipboardDocumentListIcon className='h-5 w-5 text-blue-500' />
                    ),
                    label: 'History Peminjaman Buku',
                },
            ],
        },
        {
            ...
            isOpen:
                isInventarisOpen ||
                location.pathname.startsWith('/dosen/katalog-inventaris') ||
                location.pathname.startsWith(
                    '/dosen/histori-peminjaman-inventaris',
                ),
            toggle: handleInventarisToggle,
            subItems: [
                {
                    to: '/dosen/katalog-inventaris',
                    icon: (
                        <DocumentTextIcon className='h-5 w-5 text-blue-500' />
                    ),
                ...
                {
                    to: '/dosen/katalog-inventaris/cart',
                    icon: (
                        <ShoppingCartIcon className='h-5 w-5 text-blue-500' />
                    ),
                ...
                {
                    to: '/dosen/histori-peminjaman-inventaris',
                    icon: (
                        <ClipboardDocumentListIcon className='h-5 w-5 text-blue-500' />
                    ),
                    label: 'History Peminjaman Inventaris',
                },
            ],
        },
        {
            to: '/dosen/jasa/riwayat',
