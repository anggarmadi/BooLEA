...
import HistoryPeminjamanInventarisKonten from '../Konten/HistoryPeminjamanInventarisKonten copy';
...
function MahasiswaHistoryPeminjamanInventarisPage() {
    ...
    const fetchData = async (page = 1, query = '') => {
        setLoading(true);
        try {
            const response = await api.get('/api/peminjaman/inventaris-user', {
                params: {
                    search_query: query,
                    page: page - 1,
                    limit: itemsPerPage,
                    ...
                    <div className='container mx-auto p-4 bg-white shadow-md rounded'>
                        ...
                        <div className='overflow-x-auto'>
                            ...
                            {loading ? (
                                ...
                                <HistoryPeminjamanInventarisKonten
                                    data={data}
...
export default MahasiswaHistoryPeminjamanInventarisPage;
