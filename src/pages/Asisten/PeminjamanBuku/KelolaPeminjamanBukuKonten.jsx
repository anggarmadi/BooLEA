...
const KelolaPeminjamanBukuKonten = ({
    data,
    currentPage,
    totalPages,
    onPageChange,
    ...
    const renderBooks = (detailPeminjamanBuku) => {
        return detailPeminjamanBuku
            .map((detail) => detail.buku.title)
            .join(', ');
    };
                    ...
                    <tbody>
                        {data.map((peminjaman, index) => (
                            <tr key={peminjaman.id} className='md:table-row'>
                                ...
                                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                                    {formatToRupiah(peminjaman.denda)}
                                </td>
                                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
...
export default KelolaPeminjamanBukuKonten;
